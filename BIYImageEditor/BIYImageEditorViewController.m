...
- (void)viewDidLayoutSubviews
{
    ...
    _imageView.layer.mask = [[UIImageView alloc] initWithImage:[self createMaskImage]].layer;
}
...
- (UIImage *)createMaskImage
{
    ...
    UIView *circleView = [[UIView alloc] initWithFrame:CGRectMake(CGRectGetMinX(_areaView.frame) + 1.0,
                                                                  ...
                                                                  CGRectGetWidth(_areaView.frame) - 1.0,
                                                                  CGRectGetHeight(_areaView.frame) - 1.0)];
    ...
    UIGraphicsBeginImageContextWithOptions(rectView.bounds.size, false, 0.0);
